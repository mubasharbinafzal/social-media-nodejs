...
//database config
const URL = process.env.MONGODB_URI || 'mongodb+srv://meetup:pAkis786tan@cluster0.dptzlf0.mongodb.net/meetUp?retryWrites=true&w=majority';
...
app.get("/", (req, res) => {
  return res.status(200).send("Helloooo, Worldddddd!");
});
